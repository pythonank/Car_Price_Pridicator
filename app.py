...
# Paths to files
pipeline_path = r'C:\Users\ankit\Downloads\car_price_pipeline.pkl'
model_path = r'C:\Users\ankit\Downloads\car_price_model.pkl'
# Load files
...
# User inputs
car_age = st.number_input("Year of Manufacture", min_value=4, max_value=32, value=24)
...
if st.button("Predict Selling Price"):
    if pipeline and model:
        # Create DataFrame
        input_data = pd.DataFrame([[car_age, km_driven, fuel, seller_type, transmission, owner]],
                                  columns=['car_age', 'km_driven', 'fuel', 'seller_type', 'transmission', 'owner'])
